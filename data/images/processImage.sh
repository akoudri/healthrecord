...
convert -resize 96x96 $1.png $1-xxhdpi.png
convert -resize 72x72 $1.png $1-xhdpi.png
convert -resize 48x48 $1.png $1-hdpi.png
convert -resize 36x36 $1.png $1-mdpi.png
